    ...
    public class OptionsMenuBehaviourStartPatch {
        ...
        public static void Postfix(OptionsMenuBehaviour __instance) {
            ...
            if ((ghostsSeeTasksButton == null || ghostsSeeTasksButton.gameObject == null)) {
                ...
                ghostsSeeTasksButton = createCustomToggle("Les fantômes voient les Tasks restantes: ", TheOtherRolesPlugin.GhostsSeeTasks.Value, Vector3.right * xOffset, (UnityEngine.Events.UnityAction)ghostsSeeTaskToggle, __instance);
            ...
            if ((ghostsSeeRolesButton == null || ghostsSeeRolesButton.gameObject == null)) {
                ...
                ghostsSeeRolesButton = createCustomToggle("Les fantômes voient les Roles: ", TheOtherRolesPlugin.GhostsSeeRoles.Value, new Vector2(-xOffset, yOffset), (UnityEngine.Events.UnityAction)ghostsSeeRolesToggle, __instance);
