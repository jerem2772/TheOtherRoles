...
using UnityEngine;
using System.Linq;  //For Better Polus

namespace TheOtherRoles
{

    [HarmonyPatch(typeof(ShipStatus))]
    public class BetterPolus
    {
        // ------------------------------------------------
        // ------------- Better Polus  v1.2.1 -------------
        // ------------------------------------------------
        // https://github.com/amsyarasyiq/BetterPolus
        ...
        public static void AdjustPolus()
        {
            ...
            {
                System.Console.WriteLine("Couldn't move elements as not all of them have been fetched.");
            }
        ...
        public static void AdjustVents()
        {
            ...
            {
                System.Console.WriteLine("Couldn't adjust Vents as not all objects have been fetched.");
            }
        }
